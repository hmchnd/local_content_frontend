		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comkposupplierreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkposupplierreport-display": {
								"semanticObject": "comkposupplierreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kpo.supplierreport",
									"url": sap.ui.require.toUrl("com/kpo/supplierreport")
								}
							}
						}
					}
